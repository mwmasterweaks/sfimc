  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="{{URL::to('admin/bower_components/select2/dist/css/select2.min.css') }}">
  ...
  <link href="{{ URL::to('admin/css/getorgchart/css/getorgchart.css') }}" rel="stylesheet" />

  <link href="{{ URL::to('admin/css/base.css') }}" rel="stylesheet">
  <link href="{{ URL::to('admin/css/custom-style.css') }}" rel="stylesheet" />
  <link href="{{ URL::to('admin/bower_components/jquery-ui-1.12.1/jquery-ui.css') }}" rel="stylesheet" />
