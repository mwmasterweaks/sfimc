...
@section('content')
	          	...
	          	<div class="modal-body">
		            ...
		            <div class="row">
		            	<div class="col-md-4">
			                ...
			                <div class="col-md-12">
			                    <input id="CustomerType" type="text" class="form-control" value="" style="width:100%; font-weight:normal;" readonly>
			                </div>
		            	</div>
		            	<div id="divMember" class="col-md-4">
			                ...
			                <div class="col-md-12">
	                            ...
	                            <input type="text" id="MemberName" name="MemberName" placeholder="Search by Member No., Member Name" class="form-control" style="width:100%; font-weight:normal;" readonly>
			                </div>
		            	</div>
		            	<div id="divGuest" class="col-md-4" style="display: none;">
			                ...
			                <div class="col-md-12">
			                    <input id="CustomerName" type="text" class="form-control" value="" style="width:100%; font-weight:normal;" readonly>
			                </div>
		            	</div>
		            </div>
		            ...
		            <div class="row">
		            	...
		            	<div class="col-md-4">
			                ...
			                <div class="col-md-12" style="font-weight: normal;">
			                    <input id="City" type="text" class="form-control" value="" style="width:100%; font-weight:normal;" readonly>
			                </div>
		            	</div>
		            	<div class="col-md-4">
			                <label class="col-md-12" style="font-weight: normal;">State/Province</label>
			                <div class="col-md-12">
			                    <input id="StateProvince" type="text" class="form-control" value="" style="width:100%; font-weight: normal;" readonly>
			                </div>
		            	</div>
		            	<div class="col-md-4">
			                <label class="col-md-12" style="font-weight: normal;">Zip Code</label>
			                <div class="col-md-12">
			                    <input id="ZipCode" type="text" class="form-control" value="" style="width:100%; font-weight: normal;" readonly>
			                </div>
		            	</div>
		            	<div class="col-md-12">
			                <label class="col-md-12" style="font-weight: normal;">Country <span style="color:red;">*</span></label>
			                <div class="col-md-12" style="font-weight: normal;">
			                    <input id="Country" type="text" class="form-control" value="" style="width:100%; font-weight: normal;" readonly>
			                </div>
		            	</div>
		            	...
		            	<div class="col-md-6">
				            ...
				            <div class="row">
				            	<div class="col-md-12">
					                ...
					                <div class="col-md-12">
					                    <input id="ModeOfPayment" type="text" class="form-control" value="" style="width:100%; font-weight: normal;" readonly>
					                </div>
				            	</div>
			            	</div>
				            ...
				            <div class="row">
				            	<div class="col-md-12">
					                ...
					                <div class="col-md-12">
					                    <input id="Shipper" type="text" class="form-control" value="" style="width:100%; font-weight: normal;" readonly>
					                </div>
				            	</div>
			            	</div>		            		
				            <div class="row">
				            ...
				            <div class="row">
				            	<div class="col-md-12">
									<div class="input-group margin pull-right">
										...
										<input id="ShippingCharges" type="text" placeholder="Shipping Charges" class="form-control DecimalOnly RecomputeTotal" style="width:100%; font-weight:normal; text-align: right;" readonly>
									</div>		
								</div>		
							</div>	
				            <div class="row">
	...
	<script type="text/javascript">
	    ...
	    function getRecordList(vPageNo, vSearchText){
			$.ajax({
				...
				data: {
					_token: '{{ $Token }}',
					CenterID: 0,
					CustomerEntryID: {{ Session("MEMBER_ENTRY_ID") }},
			...
			tdOption = " <div class='input-group-btn' style='padding-left:10px; float:left; display: inline-block;'>" +
	                        ...
	                        "<ul class='dropdown-menu'> ";
		                  	tdOption += " <li style='text-align:left;'> " +
		                      	" <a href='#' onclick='EditOrder(" + vData.OrderID + "," + false + ")'>" + 
		                      		" <strong><i class='fa fa-info-circle font-size:15px;'></i> View Order</strong>" +
		                      	" </a> " +
		                   	" </li> ";
            tdOption += " </ul> " +
	                    " </div> " ;
	    ...
	    function Clearfields(){
			...
			$("#StateProvince").prop('disabled', true);
			...
			$("#ShippingCharges").prop('disabled', true);
			$("#TotalDiscountPercent").prop('disabled', true);
			$("#TotalDiscount").prop('disabled', true);
			$("#TotalCashPayment").prop('disabled', true);
				...
				$.ajax({
					...
					success: function(data){
						...
						if(data.Response =='Success' && data.OrderInfo != undefined){
							...
							$("#CustomerType").val(data.OrderInfo.CustomerType);
							$("#divMember").hide();
							$("#divGuest").hide();
							...
							$("#City").val(data.OrderInfo.City);
							$("#StateProvince").val(data.OrderInfo.StateProvince);
							$("#ZipCode").val(data.OrderInfo.ZipCode);
							$("#Country").val(data.OrderInfo.Country);

							$("#ModeOfPayment").val(data.OrderInfo.ModeOfPayment);
							$("#Shipper").val(data.OrderInfo.ShipperName);
