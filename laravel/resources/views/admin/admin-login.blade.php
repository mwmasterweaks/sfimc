...
<head>
    <title>Admin Login | SUCCESS FORMULA INTL</title>
        ...
        <div class="row">
                    ...
                    <p>Please click on login to continue, username & password required.</p>
                      <div class="admin-sidebar-info">
                                  <ul>
                                      ...
                                      <li><a href="{{ URL::route('member-login') }}" style="color:green;">Login To Member Panel</a></li>
                                  </ul>
                                </div>
                </div>
                <div class="bg-photo">
            ...
            <div class="col-xl-4 col-lg-5 col-md-12 bg-color-6" style = "background: linear-gradient(110.1deg, rgb(34, 126, 34) 2.9%, rgb(168, 251, 60) 90.3%);">
                <div class="form-section" id="divLogin">
                    ...
                    <h3 style = "color:#fff" >Administrator Login</h3>
              ...
              @endif
                            <div class="form-group clearfix">
                                ...
                                <div class="form-box">
                                    <input name="Username" type="text" class="form-control" id="first_field" placeholder="Username" aria-label="Email Address">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="form-box">
                                    <input name="UserPassword" type="password" id="inputStylePassword" class="form-control" autocomplete="off" id="second_field" placeholder="Password" aria-label="Password">
