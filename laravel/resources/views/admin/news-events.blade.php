...
@section('content')
		            	...
		            	<div class="col-md-12">
			            	<div class="col-md-12">
		                        ...
		                        <div class="file-preview-frame">
		                            ...
		                            <img id="output" src="{{ URL::to('public/img/newsevents/no-image-300x300.jpg') }}" style="max-width: 500px;" />
		                       	</div>
		                   	</div>
	                   	</div>
	            	</div>
	...
	<script type="text/javascript">
	    ...
	    function Clearfields(){
			...
			$("#output").attr("src","{{ URL::to('public/img/newsevents/no-image-300x300.jpg') }}");
				...
				$.ajax({
					...
					success: function(data){
						...
						if(data.Response =='Success' && data.NewsEventsInfo != undefined){
							...
							$("#output").attr("src","{{ URL::to('public/img/newsevents') }}/" + data.NewsEventsInfo.RecordID + "-1-300x300.jpg");
