...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header" style="text-align:center; background-color:#222d32; color:white; margin-left:2px; margin-right:2px;">
            <h3 class="box-title"><strong>Change Member Password</strong></h3>
        </div><!-- /.box-header -->
        ...
        <div class="box-body table-responsive">
            ...
            <div class="col-md-12">
                <form class="form-horizontal " action="{{ route('do-change-member-password') }}" method="post"  enctype="multipart/form-data">
