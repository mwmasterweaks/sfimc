...
<script src="{{ asset(config('app.src_name') . 'assets/js/jquery-3.6.0.min.js') }}"></script>
<script src="{{ asset(config('app.src_name') . 'assets/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset(config('app.src_name') . 'assets/js/jquery.validate.min.js') }}"></script>
<script src="{{ asset(config('app.src_name') . 'assets/js/app.js') }}"></script>
<!-- Custom JS Script -->
