        ...
        <div class="box-body table-responsive">
           nth Level <select name="cars" id="cars" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                <option value="">Select</option>
                  <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=4">3rd level</option>
                    <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=5">4th level</option>
  <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=6">5th level</option>
  <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=7">6th level</option>
  <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=8">7th level</option>
  <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=9">8th level</option>
  <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=10">9th level</option>
  <option value="{{ route('member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=11">10th level</option>
</select>
            ...
            <div style = "display:flex;float:right">
              ...
              <br>
             <span style = "color:green">Showing level <?php  echo $lvls-1; ?></span> 
               <br>
{{-- 
 ...
 --}}
   ...
   <script type="text/ecmascript">
            ...
            <style type="text/css">
                ...
                @foreach($TREE as $child)
                    @if($child->PackageID == 1 OR $child->PackageID == 6)
                    ...
                    @elseif($child->PackageID == 3)
                        g[data-node-id='{{ $child->Cntr }}'] > path {
                         ...
                         @elseif($child->PackageID == 4)
                        g[data-node-id='{{ $child->Cntr }}'] > path {
                            fill: #d17b99 !important;
                            stroke: #f8e692 !important;
                        }
                    @else
                        g[data-node-id='{{ $child->Cntr }}'] > path {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmSubmit"  name="frmSubmit" method="get" action="{{ route('member-genealogy') }}">
