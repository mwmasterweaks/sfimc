...
@section('content')
	...
	<script type="text/javascript">
	    ...
	    function getRecordList(vPageNo){
			...
			$.ajax({
				...
				success: function(data){
					LoadRecordList(data.CommissionList);
			        $("#divLoader").hide();
				},
				error: function(data){
	    ...
	    function LoadRecordRow(vData){
			...
			tdTotalCommission = "<span style='font-weight:normal;' class='pull-right'>" + FormatDecimal(vData.TotalCommission,2) + "</span>";
