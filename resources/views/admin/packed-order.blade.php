...
@section('content')
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Packed Order</li>
		</ol>
	</section>
	...
	<div id="set-shipped-modal" class="modal fade bs-example-modal-lg" style="display:none;"> 
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">

	          <div class="modal-header" style="background-color: #3c8dbc;">
	            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	            <h4 class="modal-title"  style="text-align:center; color:white;"><span><b>Order - Set As Shipped</b></span></h4>
	          </div>

	          <div class="modal-body">

	        	<input type="hidden" id="ShippedOrderID" value="0" readonly>

	            <div class="row">
	            	<div class="col-md-12">
		                <label class="col-md-12" style="font-weight: normal;">Are you sure you want to set this order as shipped?</label>
	            	</div>
            	</div>
	            <div style="clear:both;"></div>
	            <br>                
	            <div class="row">
	            	<div class="col-md-12">
		                <label class="col-md-12" style="font-weight: normal;">Tracking No. </label>
		                <div class="col-md-12">
	                		<input id="ShipperTrackingNo" type="text" class="form-control" value="" style="width:100%; font-weight:normal;">
		                </div>
	            	</div>
	            </div>
	            ...
	            <div class="modal-footer">
					<div class="input-group pull-right">
						<span class="input-group-btn">
							<a id="btnShippedOrder" href="#" class="btn btn-info btn-flat" onclick="ProceedShippedOrder()"><i class="fa fa-save"></i> Proceed</a>
							<a href="#" class="btn btn-danger btn-flat" data-dismiss="modal" aria-label="Close"><i class="fa fa-remove"></i> Cancel</a>
						</span>
					</div>	
	            </div>
	...
	<script type="text/javascript">
			...
			tdOption = " <div class='input-group-btn' style='padding-left:10px; float:left; display: inline-block;'>" +
	                        ...
	                        "<ul class='dropdown-menu'> ";
		                  	tdOption += " <li style='text-align:left;'> " +
		                   	...
		                   	" </li> ";
                      	tdOption += " <li style='text-align:left;'> " +
                          	" <a href='#' onclick='SetAsShipped(" + vData.OrderID + ")'>" + 
                          		" <strong><i class='fa fa-minus-circle' style='font-size:15px;'></i> Set As Shipped " + 
                          		" </strong>" +
                          	" </a> " +
                       	" </li> ";
	    ...
	    function SetAsShipped(vOrderID){

	    	if(vOrderID > 0){

				$("#ShippedOrderID").val(vOrderID);
				$("#ShipperTrackingNo").val('');
				$("#set-shipped-modal").modal();

	    	}

	    }

	    function ProceedShippedOrder(){

			$.ajax({
				type: "post",
				data: {
					_token: '{{ $Token }}',
					OrderID: $("#ShippedOrderID").val(),
					ShipperTrackingNo: $("#ShipperTrackingNo").val()
				},
				url: "{{ route('do-shipped-order') }}",
				dataType: "json",
				success: function(data){
					buttonOneClick("btnShippedOrder", "Proceed", false);

					if(data.Response =='Success'){
						$("#set-shipped-modal").modal('hide');
						...
						showJSModalMessageJS("Shipped Order",data.ResponseMessage,"OK");
					}
				},
				error: function(data){
					buttonOneClick("btnShippedOrder", "Proceed", false);
				...
				beforeSend:function(vData){
					buttonOneClick("btnShippedOrder", "", true);
				}
        	});
