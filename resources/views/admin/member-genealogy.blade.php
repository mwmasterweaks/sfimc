        ...
        <div class="box-body table-responsive">
           nth Level <select name="cars" id="cars" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                <option value="">Select</option>
                  <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=4">3rd level</option>
                    <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=5">4th level</option>
  <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=6">5th level</option>
  <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=7">6th level</option>
  <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=8">7th level</option>
  <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=9">8th level</option>
  <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=10">9th level</option>
  <option value="{{ route('admin-member-genealogy') }}?MemberEntryID={{ $mid }}&MaxLevel=100&level=11">10th level</option>
</select>
            ...
            <div style = "display:flex;float:right">
              ...
              <br>
             <span style = "color:green">Showing levelssss <?php  echo $lvls-1; ?></span> 
               <br>
{{-- 
