        ...
        <div class="container text-center">
          ...
          <div class="how-one-container">
              <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 5px;">
                 <div class="inner-box">
                    <div class="icon-box">
                       <img src="{{ asset(config('app.src_name') . 'img/award1.jpg')}}" alt="2019 Golden Globe Awards For Business Excellence and Filipino Achiever">
                    </div>
                 </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 5px;">
                 <div class="inner-box">
                    <div class="icon-box">
                       <img src="{{ asset(config('app.src_name') . 'img/award2.jpg')}}" alt="38th People's Choice Excellence Awards 2018">
                    </div>
                 </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 5px;">
                 <div class="inner-box">
                    <div class="icon-box">
                       <img src="{{ asset(config('app.src_name') . 'img/award3.jpg')}}" alt="29th Asia Pacific Excellence Awards 2017">
                    </div>
                 </div>
              </div>
